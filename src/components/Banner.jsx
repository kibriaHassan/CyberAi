  ...
  return (
    <div className='container'>
      <div className='relative '>
        <Image className='absolute -top-8.75 -left-7.75' src={iconLeft} alt="" />
        <Image className='absolute -top-8.75 -right-7.75' src={iconRight} alt="" />
      </div>

      <h1 className='text-[197.6px] text-center font-[Orbitron] font-bold -z-10'>Cyber Punk</h1>

      <div className="flex justify-center px-20 -mt-45 font-[Montserrat] z-20">
